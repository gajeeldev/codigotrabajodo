export const codigoTrabajoData = [
	{
	...
	{
		title: 'LIBRO PRIMERO: EL CONTRATO DE TRABAJO',
		content: '',
		subsections: [
			{
				title: 'TÍTULO I: DEFINICIÓN Y SUJETOS DEL CONTRATO',
				content: `Art. 1.- El contrato de trabajo es aquel por el cual una persona se obliga, mediante una retribución, a prestar un servicio personal a otra, bajo la dependencia y dirección inmediata o delegada de ésta.
			...
			},
			{
				...
				content: `Art. 15.- Se presume, hasta prueba en contrario, la existencia del contrato de trabajo en toda relación de trabajo personal. Cuando se presenten en la práctica situaciones mixtas, en las cuales el contrato de trabajo se halle involucrado con otro u otros contratos, se dará preferencia a aquel de los contratos que esté más vinculado a lo esencial del servicio prestado.
					...
					5o. Los demás que las partes pu edan convenir de acuerdo con la ley. Contendrá las firmas de las partes o sus señas digitales y las firmas de los testigos, si a ello hubiere lugar, según prevee el artículo 21. `,
			},
			{
				title: 'TÍTULO III: MODALIDADES DEL CONTRATO',
				content:
			...
			{
				title: 'TÍTULO V: DE LA SUSPENSIÓN DE LOS EFECTOS DEL CONTRATO',
				content:
			...
			{
				title: 'TÍTULO VI: DE LA MODIFICACIÓN DEL CONTRATO',
				content:
			...
			{
				title: 'TÍTULO VII: DE LA TERMINACIÓN DEL CONTRATO',
				content: `CAPÍTULO I: DE LAS CAUSAS DE TERMINACIÓN
				...
				3o. Por la imposibilidad de ejecución.
					...
					4o. Por agotamiento de la materia prima objeto de una ind ustria extractiva.
					...
					Art. 85.- El importe del auxilio de cesantía, lo mismo que el correspondiente al preaviso, cuando se ha omitido, se calculará tomando como base el promedio de los salarios devengados por el trabajador durante el último año o fracción de un año que tenga de vigencia el contrato. Para estos cálculos sólo se tendrán en cuenta los salarios correspondientes a horas ordinarias.
					...
					Art. 93.- El despido que no haya sido comunicado a la autoridad del trabajo correspondiente en la forma y en el término indicado en el artículo 91, se reputa que carece de justa causa. La querella del trabajador, en ningún caso suple la obligación del empleador.
...
Art. 98.- El derecho del trabajador a dar por terminado el contrato de trabajo, presentando su dimisión por cualquiera de las causas enunciadas en el artículo 97, caduca a los quince días. Este plazo se cuenta a partir de la fecha en que se ha generado ese derecho.
...
Art. 100.- En las cuarenta y ocho horas siguientes a la dimisión, el trabajador la comunicará, con indicación de causa, tanto al empleador, como al Departamento de Trabajo o a la autoridad local que ejerza sus funciones. La dimisión no comunicada a la autoridad del trabajo correspondiente en el término indicado en este artículo se reputa que carece de justa causa. El trabajador no esta obligado a cumplir esta obligación si la dimisión se produce ante la autoridad de trabajo correspondiente.
...
Art. 102.- Si no se comprueba la justa causa invocada como fundamento de la dimisión, el tribunal la declarará injustificada, resolverá el contrato de trabajo por culpa del trabajador y condenará a éste al pago de una indemnización en favor del empleador igual al importe del preaviso previsto en el artículo 76.
	...
	},
	{
		...
		subsections: [
			{
				title: 'TÍTULO I: DEL CONVENIO COLECTIVO DE CONDICIONES DE TRABAJO',
				content:
					...
					Art. 109.- El sindicato de trabajadores está autorizado para representar a los intereses profesionales de todos los trabajadores de una empresa, siempre que el sindicato cuente entre sus miembros con la mayoría absoluta de dichos trabajadores. A los fines de determinar la mayoría requerida en este artículo, no se tomará en consideración a los trabajadores que ocupen puestos de dirección o de inspección de labores.
					...
					Art. 112.- El sindicato de empresa tiene preferencia para la celebración de convenios colectivos con el empleador en cuya empresa trabajen sus miembros. Cuando concurran un sindicato de empresa y un sindicato por rama de actividad, se dará preferencia a la negociación por rama de actividad conforme a lo dispuesto en el artículo 110.
					...
					Art. 115.- La duración del convenio colectivo será la que se determine en el mismo, pero no podrá ser menor de un año ni mayor de tres. En caso de que no se determine expresamente su duración, la vigencia del convenio colectivo será de un año. El convenio colectivo se prorrogará automáticamente durante un período igual al estipulado o al establecido por la ley, si ninguna de las partes lo denuncia con dos meses de anticipación a la fecha de su vencimiento. Dentro de las cuarenta y ocho horas de denunciado el convenio, deberá depositarse copia de dicha denuncia en el Departamento de Trabajo.
			...
			{
				title: 'TÍTULO II: DEL REGLAMENTO INTERIOR DE TRABAJO',
				content:
	...
	},
	{
		...
		subsections: [
			{
				title: 'TÍTULO I: DE LA NACIONALIZACIÓN DEL TRABAJO',
				content:
					...
					Art. 136.- Los salarios percibidos por los trabajadores dominicanos de una empresa deben ascender, en conjunto, al ochenta por ciento, por lo menos, del valor correspondiente al pago de todo el personal. Están exceptuados de las disposiciones de este artículo los salarios percibidos por trabajadores que desempeñen labores técnicas, de dirección o gerencia.
					...
					Art. 144.- Los administradores, gerentes, directores y demás personas que ejerzan funciones de administración o de dirección deben ser preferentemente de nacionalidad dominicana. Los superintendentes, mayordomos, supervisores y cualquier otros trabajadores que laboren en faenas agrícolas deben ser de nacionalidad dominicana. Cuando un dominicano sustituye a un extranjero en uno de los cargos indicados en este artículo, debe disfrutar del mismo salario, derechos y condiciones de trabajo del sustituido.

					Art. 145.- El Poder Ejecutivo puede conceder permisos, válido por no más de un año, para que sean empleados en empresa agrícolaindustriales, braceros extranjeros en exceso de la proporción legal. Son braceros, los trabajadores a jornal utilizados exclusivamente en trabajos del campo. `,
			},
			{
				title:
					'TÍTULO II: DE LA JORNADA DE TRABAJO, DEL DESCANSO SEMANAL Y DE LOS DÍAS FERIADOS',
				content: `CAPÍTULO I: DE LA JORNADA DE TRABAJO
				...
				Art. 147.- La duración normal de la jornada de trabajo es la determinada en el contrato. No podrá exceder de ocho horas por día ni de cuarenta y cuatro horas por semana. La jornada semanal de trabajo terminará a las doce horas meridiano del día sábado. No obstante, el Secretario de Estado de Trabajo podrá disponer mediante resolución que, en atención a los requerimientos de ciertos tipos de empresas o negocios y a las necesidades sociales y económicas de las distintas regiones del país, y previa consulta con los representantes de los trabajadores, la jornada semanal de determinados establecimientos termine a una hora diferente a la arriba señalada.
					...
					3o. Los días de descanso semanal de cada trabajador. Quedan exceptuados de esta disposición los trabajadores del campo.
					...
					4o. Monto de las remuneraciones debidas. 5o. Edad y sexo.
			...
			{
				title: 'TÍTULO III: DEL CIERRE DE ESTABLECIMIENTO Y EMPRESA',
				content:
			...
			{
				title: 'TÍTULO IV: DE LAS VACACIONES',
				content:
					`Art. 177.- (Modificado por la Ley núm. 9797, G.O. 9955, de fecha 31 de mayo de 1997). Los empleadores tienen la obligación de conceder a todo trabajador un período de vacaciones de catorce (14) días laborables, con disfrute de salario, conforme a la escala siguiente:
					...
					Art. 184.- (Modificado por la Ley núm. 2598, G.O. 9972 de fecha 15 de enero del 1998). El derecho de compensación por vacaciones no disfrutadas debe ser pagado, sea cual fuere la causa de terminación del contrato.
					...
					Art. 186.- Los empleadores deben fijar y distribuir, durante los primeros quince días del mes de enero, los períodos de vacaciones de sus trabajadores. Deben, además, en el mismo plazo, enviar al Departamento de Trabajo copia de la distribución y fijar otra en lugar visible de sus talleres o establecimientos.
					...
					c) La remuneración recibida por cada trabajador durante el período de sus vacaciones anuales pagadas. En caso de no saber firmar, el trabajador estampará sus señas digitales.
					...
					Art. 191.- El empleador está obligado a reemplazar temporalmente por otros a los trabajadores en vacaciones, cuando como consecuencia de ellas las labores encomendadas al personal resulten extraordinariamente recargadas. Es potestativo del empleador aumentar la duración del período de vacaciones.`,
			},

			{
				title: 'TÍTULO V: DEL SALARIO',
				content:
					...
					Art. 198.- El salario no puede ser pagado por períodos mayores de un mes. Los trabajadores que devengan salarios por hora o por día deben ser pagados semanalmente, salvo acuerdo en contrario de las partes.
					...
					Art. 200.- El salario o los créditos provenientes de derechos reconocidos por la ley a los trabajadores son inembargables, salvo en la tercera parte por pensiones alimentarias. El embargo en exceso de la tercera parte es admisible por pensiones alimentarias dispuestas en virtud de la ley sobre asistencia obligatoria de los hijos menores de edad.
					...
					Art. 202.- Si el trabajador tiene participación en los beneficios de la empresa, el empleador está obligado a suministrarle informe acerca de las ganancias y pérdidas, a la terminación del balance general. Debe además permitir que el trabajador consulte los libros de contabilidad en cuanto pueda interesarle.
			...
			{
				title: 'TÍTULO VI: DEL SALARIO MÍNIMO',
				content:
					...
					Art. 215.- El aumento de salario previsto en el artículo puede también ser espontáneo por parte del empleador y referirse a todos los trabajadores o a un grupo de ellos.
			...
			{
				title: 'TÍTULO VII: DEL SALARIO DE NAVIDAD',
				content:
			...
			},
			{
				...
				content:
					...
					Art. 226.- Quedan exceptuados de pagar el salario de participación en los Beneficios:
					 ...
					 1o. Las empresas agrícolas, agrícolaindustriales, industriales, forestales y mineras durante sus primeros tres años de operaciones, salvo convención en contrario.
	...
	{
		title:
			'LIBRO CUARTO: DE LA REGULACIÓN OFICIAL DE LAS CONDICIONES DE ALGUNOS CONTRATOS DE TRABAJO',
		content: '',
		subsections: [
			{
				title: 'TÍTULO I: DE LA PROTECCIÓN DE LA MATERNIDAD',
				content:
					...
					Art. 236.- La trabajadora en estado de embarazo tiene derecho a un descanso obligatorio durante las seis semanas que preceden a la fecha probable del parto y las seis semanas que le siguen. Cuando la trabajadora no haga uso de todo el descanso prenatal, el tiempo no utilizado se acumula al período del descanso postnatal.
			...
			{
				title: 'TÍTULO II: DEL TRABAJO DE LOS MENORES',
				content:
					...
					Art. 251.- Se prohíbe el empleo de menores de dieciséis años en trabajos peligrosos o insalubres. La Secretaría de Estado de Trabajo determinará cuáles son estos trabajos.
					...
					Art. 253.- Ningún menor de dieciséis años puede ser empleado en expendio al detalle de bebidas embriagantes.
			...
			{
				title: 'TÍTULO III: DE LA FORMACIÓN PROFESIONAL',
				content:
					`Art. 255.- El contrato para la formación es aquel por el que el trabajador se obliga simultáneamente a prestar un trabajo y a recibir formación y el empresario a retribuir el trabajo y al mismo tiempo, a proporcionar a aquél una formación que le permita desempeñar un puesto de trabajo. Quedan expresamente excluidas del ámbito de aplicación del presente Título las prácticas profesionales realizadas por estudiantes al amparo de la legislación educativa vigente como parte integrante de sus estudios académicos, las cuales no supondrán obligaciones contractuales para el empresario.

					Art. 256.- Todo trabajador tiene derecho a que su empleador le proporcione capacitación en su trabajo que le permitan elevar su nivel de vida y su productividad, conforme a la naturaleza de sus servicios y a los requerimientos de la empresa. La formación profesional será obligatoria y gratuita para el trabajador cuando sea requerida por la empresa para mejorar su desempeño laboral. Los cursos y programas de capacitación de los trabajadores podrán formularse respecto a cada empresa, varias de ellas o respecto a una rama industrial o actividad determinada.
			...
			{
				title: 'TÍTULO IV: DEL TRABAJO DE LOS DOMESTICOS',
				content:
					...
					Art. 263.- (Modificado por la Ley núm. 10399, G.O. del 15 de noviembre del 1999). Los trabajadores domésticos tienen derecho a dos semanas de vacaciones remuneradas cada vez que cumplan un año de servicio, así como al salario previsto en el primer párrafo del artículo 219 del presente Código.

					PÁRRAFO: (Modificado por la Ley núm. 103-99, G.O. del 15 de noviembre del 1999). El monto del salario navideño será igual a la suma de dinero pagada por el (la) empleador(a) en virtud del artículo 260 del presente Código.

					Art. 264.- (Modificado por la Ley núm. 10399, G.O. del 15 de noviembre del 1999). Todo(a) trabajador(a) doméstico(a) tiene derecho a que su empleador le conceda los permisos necesarios para asistir a una escuela, al médico o a un centro de salud, en caso de enfermedad, siempre y cuando sea compatible con su jornada de trabajo o en (los) día(s) acordado(s) con su empleador.
			...
			{
				title: 'TÍTULO V: DEL TRABAJO A DOMICILIO',
				content:
					...
					4o. El certificado industrial del empleador. Dicho libro debe ser legalizado por la Secretaría de Estado de Trabajo.
					...
					Art. 272.- Todo empleador debe proveerse de una licencia antes de iniciar sus actividades en el trabajo a domicilio. Esta licencia será concedida gratuitamente por la Secretaría de Estado de Trabajo y debe renovarse anualmente. La licencia expresará:
					...
					Art. 273.- Las licencias para trabajos a domicilio sólo se concederán a los empleadores dueños de empresas que comercien con artículos cuya elaboración pueda realizarse a domicilio. Queda, por tanto, prohibido el trabajo a domicilio contratado por órgano intermediario.

					Art. 274.- La Secretaría de Estado de Trabajo, está facultada para anular las licencias concedidas, cuando haya motivos justificados. Puede asimismo, suspender por razones de higiene, previo informe médico, los trabajos en los talleres de familia.
			...
			{
				title: 'TÍTULO VI: DEL TRABAJO DEL CAMPO',
				content:
					`Art. 277.- Son trabajadores del campo, sujetos al régimen de este Título, todos los propios y habituales de una empresa agrícola, agrícolaindustrial, pecuaria o forestal.
			...
			{
				title: 'TÍTULO VII: DE LOS TRANSPORTES',
				content: `CAPÍTULO I: DEL TRANSPORTE TERRESTRE
					...
					Art. 286.- El contrato de trabajo de los trabajadores ocupados en vehículos al servicio pers onal de una sola persona o de sus parientes por orden del mismo, se rige por las disposiciones del Título IV del Libro Cuarto de este Código.
					...
					Art. 293.- Capitán es la persona que ostenta el mando de una embarcación. Tiene, con respecto a los tripulantes, la calidad de representante del empleador.
					...
					SECCIÓN SEGUNDA: DEL CONTRATO DE ENROLAMIENTO
			...
			{
				title: 'TÍTULO VIII: DE LOS VENDEDORES Y VIAJANTES DE COMERCIO',
				content:
			...
			{
				title: 'TÍTULO IX: DE LOS MINUSVÁLIDOS',
				content:
	...
	{
		title: 'LIBRO QUINTO: DE LOS SINDICATOS',
		content: '',
		subsections: [
			{
				title: 'TÍTULO I: DE LAS CLASES DE SINDICATOS',
				content:
					...
					Los sindicatos deben conservar su independencia frente a los partidos políticos y a las entidades religiosas. No pueden recibir subsidios o ayuda de los mismos.

					Art. 319.- Los sindicatos de trabajadores pueden ser de empresas, profesionales o por rama de actividad.

					Art. 320.- En los sindicatos de empresas no se tiene en cuenta, para la admisión de sus miembros la naturaleza de las actividades que ejercen, sino la condición de que presten servicios en la misma empresa.
			...
			{
				title: 'TÍTULO II: DE LOS FINES SINDICALES',
				content:
					`Art. 325.- Son fines de los sindicatos:

					1o. El estudio de las condiciones en que se realiza el trabajo en la empresa, profesión u oficio a que concierne el objeto de la asociación.

					2o. La celebración de convenios colectivos de condiciones de trabajo, la protección y defensa de los derechos que de estos convenios se deriven y la revisión de los mismos por causas justificadas, en las formas y condiciones establecidas en este Código.

					3o. La solución justa y pacífica de los conflictos económico que se susciten con motivo de la ejecución de los contratos de trabajo que celebren sus miembros.

					4o. El mejoramiento de las condiciones de trabajo, de la eficiencia en la producción y las condiciones materiales, sociales y morales de sus asociados.

					5o. El estudio y la preparación de declaraciones y de recomendaciones tendientes a que se hagan reformas legislativas para el logro de dichos fines.
			...
			{
				title: 'TÍTULO III: DEL DERECHO DE ASOCIACIÓN SINDICAL',
				content:
					...
					Se reputará entre otras, prácticas desleales o contrarias a la ética profesional del trabajo:

					1o.- Exigir a trabajadores o personas que soliciten trabajo que se abstengan de formar parte de un sindicato o que soliciten su admisión como miembro del mismo;

					2o.- Ejercer represalias contra los trabajadores en razón de sus actividades sindicales;

					3o.- Despedir o suspender un trabajador por pertenecer a un sindicato;

					4o.- Negarse a establecer, sin causa justificada, negociaciones para la celebración de convenios colectivos de condiciones de trabajo, sin que esto signifique la aceptación del empleador al pliego presentado por el sindicato de los trabajadores.
					...
					5o. Intervenir en cualquier forma en la creación o administración de un sindicato de trabajadores o sostenerlo por medios financieros o de cualquier naturaleza.

					6o.- Rehusar a tratar con los legítimos representantes de los trabajadores.

					7o.- Usar la fuerza, violencia, intimidación o amenaza, o cualquier forma de coerción contra los trabajadores o sindicatos de los trabajadores, con el objeto de impedir u obstaculizar el ejercicio de los derechos consagrados por las leyes en favor de los mismos.

					Art. 334.- Todo miembro de un sindicato puede separarse de éste en cualquier momento, a pesar de cláusulas contrarias en los estatutos, sin otra obligación que la de pagar las cuotas vencidas.
			...
			{
				title: 'TÍTULO IV: DE LA CAPACIDAD DE LOS SINDICATOS',
				content:
					`Art. 337.- Los sindicatos por efecto de su registro en la Secretaría de Estado de Trabajo, adquieren personalidad jurídica.
					...
					Art. 340.- Se prohíbe a los sindicatos ejercer el comercio, así como realizar actividades contrarias a la Constitución de la República.
			...
			{
				title: 'TÍTULO V: DEL PATRIMONIO DEL SINDICATO Y SU ADMINISTRACIÓN',
				content:
					`Art. 341.- El patrimonio de un sindicato se forma:

					1o. Con las cuotas de sus miembros y otras contribuciones obligatorias, cuyo motivo y exigibilidad deben fijarse en los estatutos.

					2o. Con las contribuciones voluntarias de sus miembros o de terceros.

					3o. Con los demás bienes que adquiera a título gratuito u oneroso.
			...
			{
				title: 'TÍTULO VI: DEL FUNCIONAMIENTO DE LOS SINDICATOS',
				content:
					...
					Art. 351.- Todos los miembros del sindicato, sin distinción de edad, sexo o nacionalidad, tienen derecho igual de asistir a las sesiones de la asamblea general, expresar en ella sus opiniones y votar por las resoluciones que se someten regularmente.

					En caso de delegación, todos los miembros del sindicato tienen derecho a participar en la elección de los delegados.

					Art. 352.- El derecho de asistir a las asambleas generales y de elegir delegados a las mismas sólo puede ejercerse personalmente por los miembros del sindicato.
					...
					1o. Que la asamblea general haya sido convocada en la forma y con la anticipación prevista en los estatutos.

					2o. Que la asamblea general esté regularmente constituida.

					3o. Que la resolución se refiera a una cuestión señalada en la convocatoria y que cuente con el voto favorable de más de la mitad de los miembros o delegados presentes, a menos que la ley o los estatutos exijan otra mayoría.

					4o. Que se levante acta de la sesión, en la que se exprese el número de los miembros o delegados presentes, el orden del día y el texto de las resoluciones adoptadas, y que el acta esté firmada por las personas que hayan ejercido las funciones de presidente y secretario de la asamblea.

					5o. Que se anexe al acta de la asamblea una nómina de los miembros o delegados presentes, con la certificación jurada de los funcionarios que firman el acta.
					...
					Art. 366.- Los comisarios deben presentar un informe sobre las cuentas que el consejo manda anualmente a la asamblea general. La deliberación que contenga aprobación de las cuentas será nula si no es precedida del informe de los comisarios.
					...
					1o. Un libro en que se anoten los nombres u apellidos, profesión, domicilio y cédula personal de identidad de cada uno de sus miembros.

					2o. Un libroinventario de los bienes muebles e inmuebles del sindicato.

					3o. Un libro diario en que figuren los ingresos y egresos del sindicato con indicación exacta de su procedencia e inversión, y cualquier otros libros de contabilidad llevados con el mismo objeto.

					4o. Los libros de actas de la asamblea general, del consejo directivo y de los demás organismos que dependen del sindicato.

					Art. 372.- La duración del sindicato es siempre por tiempo indefinido. `,
			},
			{
				title: 'TÍTULO VII: DE LA CONSTITUCIÓN DEL SINDICATO',
				content:
					...
					2o. Del acta de la asamblea general constitutiva, donde se establece que los participantes han decidido democráticamente constituir el sindicato, aprobar sus estatutos y elegir libremente sus representantes.

					3o. De la nómina de los miembros fundadores.

					4o. De la convocatoria a los trabajadores de la empresa a la asamblea constitutiva.
			...
			{
				title:
					'TÍTULO VIII: DE LA DISOLUCIÓN DEL SINDICATO Y DE LA CANCELACIÓN DEL REGISTRO',
				content:
					...
					Art. 379.- El sindicato de empresas se disuelve de pleno derecho por el cierre definitivo de la empresa a que corresponde.
			...
			{
				title: 'TÍTULO IX: DE LAS FEDERACIONES Y CONFEDERACIONES DE SINDICATOS',
				content:
					...
					Art. 386.- Las federaciones y confederaciones de sindicatos están sujetas a la formalidad de registros que en este Código se establece para los sindicatos.
			...
			{
				title: 'TÍTULO X: DEL FUERO SINDICAL',
				content:
					...
					Art. 394.- El fuero sindical cesa para el trabajador que lo disfruta, si ejecuta, dirige o participa en las acciones siguientes:
					...
					2o. Por coartar, directa o indirectamente, la libertad de trabajo, tomar medidas o realizar actos que impidan a los trabajadores concurrir a su trabajo o cumplir con sus obligaciones laborales.

					3o. Por atentar contra los bienes situados en la empresa.

					4o. Por incitar o participar en actos que produzcan destrucción de materiales, instrumentos o productos de trabajo o mercaderías o disminuyan su valor o causen su deterioro.

					5o. Por incitar, dirigir o participar en la reducción intencional del rendimiento o en la interrupción o entorpecimiento ilegal de actividades totales o parciales, en la empresa de trabajo.
	...
	{
		title:
			'LIBRO SEXTO: DE LOS CONFLICTOS ECONÓMICOS, DE LAS HUELGAS Y DE LOS PAROS',
		content: '',
		subsections: [
			{
				title: 'TÍTULO I: DE LOS CONFLICTOS ECONÓMICOS',
				content:
			...
			{
				title: 'TÍTULO II: DE LAS HUELGAS',
				content:
					...
					Art. 404.- Son servicios esenciales para los fines de aplicación del artículo precedente, los de comunicaciones, los de abastecimiento de agua, los de suministro de gas o electricidad para el alumbrado y usos domésticos, los farmacéuticos, de hospitales y cualesquier otros de naturaleza análoga.
					...
					1o. Que la huelga tiene por objeto la solución de un conflicto económico o de derecho que afecte el interés colectivo de los trabajadores de la empresa.

					2o. Que la solución del conflicto ha sido sometida infructuosamente a los procedimientos de conciliación administrativa y las partes o una de ellas no han designado árbitros o no han declarado oportunamente la designación de éstos conforme a lo dispuesto en el artículo 680.

					3o. Que la huelga ha sido votada por más de cincuenta y uno por ciento de los trabajadores de la empresa o empresas de que se trata.

					4o. Que los servicios que la huelga va a comprender no son servicios esenciales.
					...
					En la cuarenta y ocho horas subsiguientes al recibo de la notificación, dicha Secretaría enviará copia de la misma a la parte empleadora.

					Art. 408.- La huelga declarada después de cumplidas las formalidades del artículo 407, produce los efectos siguientes:

					1o. Da facultad a los trabajadores de reclamar la protección de las autoridades del trabajo y de la policía, para el ejercicio pacífico de sus derechos.

					2o. Suspende los trabajos de la empresa de que se trata, salvo lo que se dispone en el artículo 409.
					...
					1o. Cuando cesa la huelga por cualquier causa.

					2o. Cuando se inicia el procedimiento de arbitraje.
	...
	{
		title: 'LIBRO SÉPTIMO: DE LA APLICACIÓN DE LA LEY',
		content: '',
		subsections: [
			{
				...
				El laudo que estos dicten no producirá efecto jurídico válido, cuando desconozca disposiciones de la ley cuyo carácter sea de orden público.
					...
					SECCIÓN PRIMERA: DE LA ORGANIZACIÓN DE LOS TRIBUNALES DE TRABAJO
			...
			},
			{
				...
				Se reputan sumarias relativas a la ejecución de convenios colectivos y de laudos sobre conflictos económicos, a los ofrecimientos reales y la consignación y al desalojo de viviendas.
					...
					SECCIÓN PRIMERA: DEL PROCEDIMIENTO DE CONCILIACIÓN
			...
			},
			{
				...
				content: `CAPÍTULO I: DE LA APELACIÓN
	...
	{
		title: 'LIBRO OCTAVO: DE LA RESPONSABILIDAD Y DE LAS SANCIONES',
		content: '',
		subsections: [
			{
...
export default codigoTrabajoData
