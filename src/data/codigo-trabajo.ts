export const codigoTrabajoData = [
  ...
  {
    title: "LIBRO SEGUNDO: DE LA REGULACIÓN PRIVADA DE LAS CONDICIONES DEL CONTRATO DE TRABAJO",
    content: "",
    subsections: [
      {
  ...
  {
    title: "LIBRO TERCERO: DE LA REGULACIÓN OFICIAL DE LAS CONDICIONES ORDINARIAS DEL CONTRATO DE TRABAJO",
    content: "",
    subsections: [
      {
      ...
      {
        title: "TÍTULO II: DE LA JORNADA DE TRABAJO, DEL DESCANSO SEMANAL Y DE LOS DÍAS FERIADOS",
        content:
          "Art. 146.- Jornada de trabajo es todo el tiempo que el trabajador no pueda utilizar libremente, por estar a la disposición exclusiva de su empleador.\n\nArt. 147.- La duración normal de la jornada de trabajo es la determinada en el contrato. No podrá exceder de ocho horas por día ni de cuarenta y cuatro horas por semana.",
      },
    ],
  },
  {
    title: "LIBRO CUARTO: DE LA REGULACIÓN OFICIAL DE LAS CONDICIONES DE ALGUNOS CONTRATOS DE TRABAJO",
    content: "",
    subsections: [
      {
  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        content:
          "Art. 325.- Son fines de los sindicatos: 1o. El estudio de las condiciones en que se realiza el trabajo en la empresa, profesión u oficio a que concierne el objeto de la asociación. 2o. La celebración de convenios colectivos de condiciones de trabajo, la protección y defensa de los derechos que de estos convenios se deriven y la revisión de los mismos por causas justificadas, en las formas y condiciones establecidas en este Código.",
      },
    ],
  },
  {
    title: "LIBRO SEXTO: DE LOS CONFLICTOS ECONÓMICOS, DE LAS HUELGAS Y DE LOS PAROS",
    content: "",
    subsections: [
      {
  ...
  },
  {
    ...
    subsections: [
      ...
      {
        title: "TÍTULO II: DEL PROCEDIMIENTO ANTE LOS TRIBUNALES DE TRABAJO EN LOS CONFLICTOS JURÍDICOS",
        content:
